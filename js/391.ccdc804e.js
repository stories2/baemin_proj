 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Ae{constructor(e){this.onMessage_=e,this.pendingResponses=[],this.currentResponseNum=0,this.closeAfterResponse=-1,this.onClose=null}closeAfter(e,t){this.closeAfterResponse=e,this.onClose=t,this.closeAfterResponse<this.currentResponseNum&&(this.onClose(),this.onClose=null)}handleResponse(e,t){this.pendingResponses[e]=t;while(this.pendingResponses[this.currentResponseNum]){const e=this.pendingResponses[this.currentResponseNum];delete this.pendingResponses[this.currentResponseNum];for(let t=0;t<e.length;++t)e[t]&&de((()=>{this.onMessage_(e[t])}));if(this.currentResponseNum===this.closeAfterResponse){this.onClose&&(this.onClose(),this.onClose=null);break}this.currentResponseNum++}}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * limitations under the License.
 */
function un(e,t){return X(e.name,t.name)}function _n(e,t){return X(e,t)}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let Pn;const xn={};class Rn{constructor(e,t){this.indexes_=e,this.indexSet_=t}static get Default(){return(0,T.hu)(xn&&En,"ChildrenNode.ts has not been loaded"),Pn=Pn||new Rn({".priority":xn},{".priority":En}),Pn}get(e){const t=(0,T.DV)(this.indexes_,e);if(!t)throw new Error("No index defined for "+e);return t instanceof dn?t:null}hasIndex(e){return(0,T.r3)(this.indexSet_,e.toString())}addIndex(e,t){(0,T.hu)(e!==an,"KeyIndex always exists and isn't meant to be added to the IndexMap.");const n=[];let i=!1;const s=t.getIterator(nn.Wrap);let r,o=s.getNext();while(o)i=i||e.isDefinedOn(o.node),n.push(o),o=s.getNext();r=i?Nn(n,e.getCompare()):xn;const a=e.toString(),l=Object.assign({},this.indexSet_);l[a]=e;const h=Object.assign({},this.indexes_);return h[a]=r,new Rn(h,l)}addToIndexes(e,t){const n=(0,T.UI)(this.indexes_,((n,i)=>{const s=(0,T.DV)(this.indexSet_,i);if((0,T.hu)(s,"Missing index implementation for "+i),n===xn){if(s.isDefinedOn(e.node)){const n=[],i=t.getIterator(nn.Wrap);let r=i.getNext();while(r)r.name!==e.name&&n.push(r),r=i.getNext();return n.push(e),Nn(n,s.getCompare())}return xn}{const i=t.get(e.name);let s=n;return i&&(s=s.remove(new nn(e.name,i))),s.insert(e,e.node)}}));return new Rn(n,this.indexSet_)}removeFromIndexes(e,t){const n=(0,T.UI)(this.indexes_,(n=>{if(n===xn)return n;{const i=t.get(e.name);return i?n.remove(new nn(e.name,i)):n}}));return new Rn(n,this.indexSet_)}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * limitations under the License.
 */
function Bn(e){return{type:"value",snapshotNode:e}}function Vn(e,t){return{type:"child_added",snapshotNode:t,childName:e}}function jn(e,t){return{type:"child_removed",snapshotNode:t,childName:e}}function Hn(e,t,n){return{type:"child_changed",snapshotNode:t,childName:e,oldSnap:n}}function Yn(e,t){return{type:"child_moved",snapshotNode:t,childName:e}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const ci=1e4,di=3e4,ui=3e5;class _i{constructor(e,t){this.server_=t,this.statsToReport_={},this.statsListener_=new hi(e);const n=ci+(di-ci)*Math.random();_e(this.reportStats_.bind(this),Math.floor(n))}reportStats_(){const e=this.statsListener_.get(),t={};let n=!1;ie(e,((e,i)=>{i>0&&(0,T.r3)(this.statsToReport_,e)&&(t[e]=i,n=!0)})),n&&this.server_.reportStats(t),_e(this.reportStats_.bind(this),Math.floor(2*Math.random()*ui))}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class ms{getCompleteChild(e){return null}getChildAfterChild(e,t,n){return null}}const gs=new ms;class ys{constructor(e,t,n=null){this.writes_=e,this.viewCache_=t,this.optCompleteServerCache_=n}getCompleteChild(e){const t=this.viewCache_.eventCache;if(t.isCompleteForChild(e))return t.getNode().getImmediateChild(e);{const t=null!=this.optCompleteServerCache_?new wi(this.optCompleteServerCache_,!0,!1):this.viewCache_.serverCache;return us(this.writes_,e,t)}}getChildAfterChild(e,t,n){const i=null!=this.optCompleteServerCache_?this.optCompleteServerCache_:Ri(this.viewCache_),s=ds(this.writes_,i,t,1,n,e);return 0===s.length?null:s[0]}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function vs(e){return{filter:e}}function Cs(e,t){(0,T.hu)(t.eventCache.getNode().isIndexed(e.filter.getIndex()),"Event snap not indexed"),(0,T.hu)(t.serverCache.getNode().isIndexed(e.filter.getIndex()),"Server snap not indexed")}function ws(e,t,n,i,s){const r=new fs;let o,a;if(n.type===pi.OVERWRITE){const l=n;l.source.fromUser?o=Es(e,t,l.path,l.snap,i,s,r):((0,T.hu)(l.source.fromServer,"Unknown source."),a=l.source.tagged||t.serverCache.isFiltered()&&!Ft(l.path),o=Ts(e,t,l.path,l.snap,i,s,a,r))}else if(n.type===pi.MERGE){const l=n;l.source.fromUser?o=Ss(e,t,l.path,l.children,i,s,r):((0,T.hu)(l.source.fromServer,"Unknown source."),a=l.source.tagged||t.serverCache.isFiltered(),o=Ps(e,t,l.path,l.children,i,s,a,r))}else if(n.type===pi.ACK_USER_WRITE){const a=n;o=a.revert?Ms(e,t,a.path,i,s,r):xs(e,t,a.path,a.affectedTree,i,s,r)}else{if(n.type!==pi.LISTEN_COMPLETE)throw(0,T.g5)("Unknown operation type: "+n.type);o=Rs(e,t,n.path,i,r)}const l=r.getChanges();return ks(t,o,l),{viewCache:o,changes:l}}function ks(e,t,n){const i=t.eventCache;if(i.isFullyInitialized()){const s=i.getNode().isLeafNode()||i.getNode().isEmpty(),r=xi(e);(n.length>0||!e.eventCache.isFullyInitialized()||s&&!i.getNode().equals(r)||!i.getNode().getPriority().equals(r.getPriority()))&&n.push(Bn(xi(t)))}}function Is(e,t,n,i,s,r){const o=t.eventCache;if(null!=cs(i,n))return t;{let a,l;if(Ft(n))if((0,T.hu)(t.serverCache.isFullyInitialized(),"If change path is empty, we must have complete server data"),t.serverCache.isFiltered()){const n=Ri(t),s=n instanceof Ln?n:Ln.EMPTY_NODE,o=ls(i,s);a=e.filter.updateFullNode(t.eventCache.getNode(),o,r)}else{const n=as(i,Ri(t));a=e.filter.updateFullNode(t.eventCache.getNode(),n,r)}else{const h=Pt(n);if(".priority"===h){(0,T.hu)(1===xt(n),"Can't have a priority with additional path components");const s=o.getNode();l=t.serverCache.getNode();const r=hs(i,n,s,l);a=null!=r?e.filter.updatePriority(s,r):o.getNode()}else{const c=Rt(n);let d;if(o.isCompleteForChild(h)){l=t.serverCache.getNode();const e=hs(i,n,o.getNode(),l);d=null!=e?o.getNode().getImmediateChild(h).updateChild(c,e):o.getNode().getImmediateChild(h)}else d=us(i,h,t.serverCache);a=null!=d?e.filter.updateChild(o.getNode(),h,d,c,s,r):o.getNode()}}return Ni(t,a,o.isFullyInitialized()||Ft(n),e.filter.filtersNodes())}}function Ts(e,t,n,i,s,r,o,a){const l=t.serverCache;let h;const c=o?e.filter:e.filter.getIndexedFilter();if(Ft(n))h=c.updateFullNode(l.getNode(),i,null);else if(c.filtersNodes()&&!l.isFiltered()){const e=l.getNode().updateChild(n,i);h=c.updateFullNode(l.getNode(),e,null)}else{const e=Pt(n);if(!l.isCompleteForPath(n)&&xt(n)>1)return t;const s=Rt(n),r=l.getNode().getImmediateChild(e),o=r.updateChild(s,i);h=".priority"===e?c.updatePriority(l.getNode(),o):c.updateChild(l.getNode(),e,o,s,gs,null)}const d=Pi(t,h,l.isFullyInitialized()||Ft(n),c.filtersNodes()),u=new ys(s,d,r);return Is(e,d,n,s,u,a)}function Es(e,t,n,i,s,r,o){const a=t.eventCache;let l,h;const c=new ys(s,t,r);if(Ft(n))h=e.filter.updateFullNode(t.eventCache.getNode(),i,o),l=Ni(t,h,!0,e.filter.filtersNodes());else{const s=Pt(n);if(".priority"===s)h=e.filter.updatePriority(t.eventCache.getNode(),i),l=Ni(t,h,a.isFullyInitialized(),a.isFiltered());else{const r=Rt(n),h=a.getNode().getImmediateChild(s);let d;if(Ft(r))d=i;else{const e=c.getCompleteChild(s);d=null!=e?".priority"===Mt(r)&&e.getChild(Ot(r)).isEmpty()?e:e.updateChild(r,i):Ln.EMPTY_NODE}if(h.equals(d))l=t;else{const n=e.filter.updateChild(a.getNode(),s,d,r,c,o);l=Ni(t,n,a.isFullyInitialized(),e.filter.filtersNodes())}}}return l}function bs(e,t){return e.eventCache.isCompleteForChild(t)}function Ss(e,t,n,i,s,r,o){let a=t;return i.foreach(((i,l)=>{const h=At(n,i);bs(t,Pt(h))&&(a=Es(e,a,h,l,s,r,o))})),i.foreach(((i,l)=>{const h=At(n,i);bs(t,Pt(h))||(a=Es(e,a,h,l,s,r,o))})),a}function Ns(e,t,n){return n.foreach(((e,n)=>{t=t.updateChild(e,n)})),t}function Ps(e,t,n,i,s,r,o,a){if(t.serverCache.getNode().isEmpty()&&!t.serverCache.isFullyInitialized())return t;let l,h=t;l=Ft(n)?i:new Di(null).setTree(n,i);const c=t.serverCache.getNode();return l.children.inorderTraversal(((n,i)=>{if(c.hasChild(n)){const l=t.serverCache.getNode().getImmediateChild(n),c=Ns(e,l,i);h=Ts(e,h,new St(n),c,s,r,o,a)}})),l.children.inorderTraversal(((n,i)=>{const l=!t.serverCache.isCompleteForChild(n)&&void 0===i.value;if(!c.hasChild(n)&&!l){const l=t.serverCache.getNode().getImmediateChild(n),c=Ns(e,l,i);h=Ts(e,h,new St(n),c,s,r,o,a)}})),h}function xs(e,t,n,i,s,r,o){if(null!=cs(s,n))return t;const a=t.serverCache.isFiltered(),l=t.serverCache;if(null!=i.value){if(Ft(n)&&l.isFullyInitialized()||l.isCompleteForPath(n))return Ts(e,t,n,l.getNode().getChild(n),s,r,a,o);if(Ft(n)){let i=new Di(null);return l.getNode().forEachChild(an,((e,t)=>{i=i.set(new St(e),t)})),Ps(e,t,n,i,s,r,a,o)}return t}{let h=new Di(null);return i.foreach(((e,t)=>{const i=At(n,e);l.isCompleteForPath(i)&&(h=h.set(e,l.getNode().getChild(i)))})),Ps(e,t,n,h,s,r,a,o)}}function Rs(e,t,n,i,s){const r=t.serverCache,o=Pi(t,r.getNode(),r.isFullyInitialized()||Ft(n),r.isFiltered());return Is(e,o,n,i,gs,s)}function Ms(e,t,n,i,s,r){let o;if(null!=cs(i,n))return t;{const a=new ys(i,t,s),l=t.eventCache.getNode();let h;if(Ft(n)||".priority"===Pt(n)){let n;if(t.serverCache.isFullyInitialized())n=as(i,Ri(t));else{const e=t.serverCache.getNode();(0,T.hu)(e instanceof Ln,"serverChildren would be complete if leaf node"),n=ls(i,e)}h=e.filter.updateFullNode(l,n,r)}else{const s=Pt(n);let c=us(i,s,t.serverCache);null==c&&t.serverCache.isCompleteForChild(s)&&(c=l.getImmediateChild(s)),h=null!=c?e.filter.updateChild(l,s,c,Rt(n),a,r):t.eventCache.getNode().hasChild(s)?e.filter.updateChild(l,s,Ln.EMPTY_NODE,Rt(n),a,r):l,h.isEmpty()&&t.serverCache.isFullyInitialized()&&(o=as(i,Ri(t)),o.isLeafNode()&&(h=e.filter.updateFullNode(h,o,r)))}return o=t.serverCache.isFullyInitialized()||null!=cs(i,Nt()),Ni(t,h,o,e.filter.filtersNodes())}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * limitations under the License.
 */
class zr{constructor(){this.eventLists_=[],this.recursionDepth_=0}}function Br(e,t){let n=null;for(let i=0;i<t.length;i++){const s=t[i],r=s.getPath();null===n||Ut(r,n.path)||(e.eventLists_.push(n),n=null),null===n&&(n={events:[],path:r}),n.events.push(s)}n&&e.eventLists_.push(n)}function Vr(e,t,n){Br(e,n),Hr(e,(e=>Ut(e,t)))}function jr(e,t,n){Br(e,n),Hr(e,(e=>Wt(e,t)||Wt(t,e)))}function Hr(e,t){e.recursionDepth_++;let n=!0;for(let i=0;i<e.eventLists_.length;i++){const s=e.eventLists_[i];if(s){const r=s.path;t(r)?(Yr(e.eventLists_[i]),e.eventLists_[i]=null):n=!1}}n&&(e.eventLists_=[]),e.recursionDepth_--}function Yr(e){for(let t=0;t<e.events.length;t++){const n=e.events[t];if(null!==n){e.events[t]=null;const i=n.getEventRunner();U&&B("event: "+n.toString()),de(i)}}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * limitations under the License.
 */
function Go(e){P(k.Jn),(0,k.Xd)(new I.wA("database",((e,{instanceIdentifier:t})=>{const n=e.getProvider("app").getImmediate(),i=e.getProvider("auth-internal"),s=e.getProvider("app-check-internal");return jo(n,i,s,t)}),"PUBLIC").setMultipleInstances(!0)),(0,k.KN)(b,S,e),(0,k.KN)(b,S,"esm2017")}
/**
 * @license
 * Copyright 2020 Google LLC
 *
