 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */en.prototype.simpleListen=function(e,t){this.sendRequest("q",{p:e},t)},en.prototype.echo=function(e,t){this.sendRequest("echo",{d:e},t)};Ko();class Go{constructor(){(0,_.Z)(this,"app",void 0),(0,_.Z)(this,"realtimeDB",void 0),this.app=(0,C.Mq)(),this.realtimeDB=$o(this.app)}getFoodShopFilterByAddress(e){return Ro(Wo(Po(this.realtimeDB,"DATA"),Lo("cgg_code_nm"),qo(e))).then((e=>e.exists()?e.val():(console.warn("No data available"),[]))).catch((e=>{console.error(`[getFoodShopFilterByAddress] error: ${e.message}`)}))}}var Qo=n(3419),Xo=n(4060),Zo=(0,i.aZ)({name:"AddressSelectBtn",components:{AddressModal:v},props:{address:String,color:String},data(){return{addrStr:this.address,dispatch:(0,Qo.H)()}},methods:{onArrowBtnClicked(){this.$refs.addressModalComponent.showModal()},onAddressLoaded(e){console.log("addressInfo",e);const t=new Go;t.getFoodShopFilterByAddress(e.region_2depth_name).then((e=>{(0,Xo.qc)({storeList:e})})),this.addrStr=`${e.region_1depth_name} ${e.region_2depth_name} ${e.region_3depth_name}`}}});const Jo=(0,g.Z)(Zo,[["render",r],["__scopeId","data-v-67393d8e"]]);var ea=Jo}}]);
//# sourceMappingURL=552.49eefb33.js.map