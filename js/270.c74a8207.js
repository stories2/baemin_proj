 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Re={},De={};function Me(e){const t=e.toString();return Re[t]||(Re[t]=new xe),Re[t]}function Fe(e,t){const n=e.toString();return De[n]||(De[n]=t()),De[n]}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Ae{constructor(e){this.onMessage_=e,this.pendingResponses=[],this.currentResponseNum=0,this.closeAfterResponse=-1,this.onClose=null}closeAfter(e,t){this.closeAfterResponse=e,this.onClose=t,this.closeAfterResponse<this.currentResponseNum&&(this.onClose(),this.onClose=null)}handleResponse(e,t){this.pendingResponses[e]=t;while(this.pendingResponses[this.currentResponseNum]){const e=this.pendingResponses[this.currentResponseNum];delete this.pendingResponses[this.currentResponseNum];for(let t=0;t<e.length;++t)e[t]&&ce((()=>{this.onMessage_(e[t])}));if(this.currentResponseNum===this.closeAfterResponse){this.onClose&&(this.onClose(),this.onClose=null);break}this.currentResponseNum++}}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let Nn;const Pn={};class xn{constructor(e,t){this.indexes_=e,this.indexSet_=t}static get Default(){return(0,I.hu)(Pn&&En,"ChildrenNode.ts has not been loaded"),Nn=Nn||new xn({".priority":Pn},{".priority":En}),Nn}get(e){const t=(0,I.DV)(this.indexes_,e);if(!t)throw new Error("No index defined for "+e);return t instanceof cn?t:null}hasIndex(e){return(0,I.r3)(this.indexSet_,e.toString())}addIndex(e,t){(0,I.hu)(e!==on,"KeyIndex always exists and isn't meant to be added to the IndexMap.");const n=[];let i=!1;const s=t.getIterator(tn.Wrap);let r,o=s.getNext();while(o)i=i||e.isDefinedOn(o.node),n.push(o),o=s.getNext();r=i?Sn(n,e.getCompare()):Pn;const a=e.toString(),h=Object.assign({},this.indexSet_);h[a]=e;const l=Object.assign({},this.indexes_);return l[a]=r,new xn(l,h)}addToIndexes(e,t){const n=(0,I.UI)(this.indexes_,((n,i)=>{const s=(0,I.DV)(this.indexSet_,i);if((0,I.hu)(s,"Missing index implementation for "+i),n===Pn){if(s.isDefinedOn(e.node)){const n=[],i=t.getIterator(tn.Wrap);let r=i.getNext();while(r)r.name!==e.name&&n.push(r),r=i.getNext();return n.push(e),Sn(n,s.getCompare())}return Pn}{const i=t.get(e.name);let s=n;return i&&(s=s.remove(new tn(e.name,i))),s.insert(e,e.node)}}));return new xn(n,this.indexSet_)}removeFromIndexes(e,t){const n=(0,I.UI)(this.indexes_,(n=>{if(n===Pn)return n;{const i=t.get(e.name);return i?n.remove(new tn(e.name,i)):n}}));return new xn(n,this.indexSet_)}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * limitations under the License.
 */
const An=!0;function Ln(e,t=null){if(null===e)return Dn.EMPTY_NODE;if("object"===typeof e&&".priority"in e&&(t=e[".priority"]),(0,I.hu)(null===t||"string"===typeof t||"number"===typeof t||"object"===typeof t&&".sv"in t,"Invalid priority type found: "+typeof t),"object"===typeof e&&".value"in e&&null!==e[".value"]&&(e=e[".value"]),"object"!==typeof e||".sv"in e){const n=e;return new Cn(n,Ln(t))}if(e instanceof Array||!An){let n=Dn.EMPTY_NODE;return ne(e,((t,i)=>{if((0,I.r3)(e,t)&&"."!==t.substring(0,1)){const e=Ln(i);!e.isLeafNode()&&e.isEmpty()||(n=n.updateImmediateChild(t,e))}})),n.updatePriority(Ln(t))}{const n=[];let i=!1;const s=e;if(ne(s,((e,t)=>{if("."!==e.substring(0,1)){const s=Ln(t);s.isEmpty()||(i=i||!s.getPriority().isEmpty(),n.push(new tn(e,s)))}})),0===n.length)return Dn.EMPTY_NODE;const r=Sn(n,un,(e=>e.name),dn);if(i){const e=Sn(n,En.getCompare());return new Dn(r,Ln(t),new xn({".priority":e},{".priority":En}))}return new Dn(r,Ln(t),xn.Default)}}wn(Ln);
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * limitations under the License.
 */
class On extends nn{constructor(e){super(),this.indexPath_=e,(0,I.hu)(!Lt(e)&&".priority"!==Nt(e),"Can't create PathIndex with empty path or .priority key")}extractChild(e){return e.getChild(this.indexPath_)}isDefinedOn(e){return!e.getChild(this.indexPath_).isEmpty()}compare(e,t){const n=this.extractChild(e.node),i=this.extractChild(t.node),s=n.compareTo(i);return 0===s?X(e.name,t.name):s}makePost(e,t){const n=Ln(e),i=Dn.EMPTY_NODE.updateChild(this.indexPath_,n);return new tn(t,i)}maxPost(){const e=Dn.EMPTY_NODE.updateChild(this.indexPath_,Fn);return new tn(Q,e)}toString(){return Mt(this.indexPath_,0).join("/")}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * limitations under the License.
 */
function Bn(e){return{type:"value",snapshotNode:e}}function zn(e,t){return{type:"child_added",snapshotNode:t,childName:e}}function jn(e,t){return{type:"child_removed",snapshotNode:t,childName:e}}function Hn(e,t,n){return{type:"child_changed",snapshotNode:t,childName:e,oldSnap:n}}function Yn(e,t){return{type:"child_moved",snapshotNode:t,childName:e}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Vn{constructor(e){this.index_=e}updateChild(e,t,n,i,s,r){(0,I.hu)(e.isIndexed(this.index_),"A node must be indexed if only a child is updated");const o=e.getImmediateChild(t);return o.getChild(i).equals(n.getChild(i))&&o.isEmpty()===n.isEmpty()?e:(null!=r&&(n.isEmpty()?e.hasChild(t)?r.trackChildChange(jn(t,o)):(0,I.hu)(e.isLeafNode(),"A child remove without an old child only makes sense on a leaf node"):o.isEmpty()?r.trackChildChange(zn(t,n)):r.trackChildChange(Hn(t,n,o))),e.isLeafNode()&&n.isEmpty()?e:e.updateImmediateChild(t,n).withIndex(this.index_))}updateFullNode(e,t,n){return null!=n&&(e.isLeafNode()||e.forEachChild(En,((e,i)=>{t.hasChild(e)||n.trackChildChange(jn(e,i))})),t.isLeafNode()||t.forEachChild(En,((t,i)=>{if(e.hasChild(t)){const s=e.getImmediateChild(t);s.equals(i)||n.trackChildChange(Hn(t,i,s))}else n.trackChildChange(zn(t,i))}))),t.withIndex(this.index_)}updatePriority(e,t){return e.isEmpty()?Dn.EMPTY_NODE:e.updatePriority(t)}filtersNodes(){return!1}getIndexedFilter(){return this}getIndex(){return this.index_}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * limitations under the License.
 */
class yi{constructor(e,t,n){this.source=e,this.path=t,this.snap=n,this.type=_i.OVERWRITE}operationForChild(e){return Lt(this.path)?new yi(this.source,St(),this.snap.getImmediateChild(e)):new yi(this.source,xt(this.path),this.snap)}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class vi{constructor(e,t,n){this.source=e,this.path=t,this.children=n,this.type=_i.MERGE}operationForChild(e){if(Lt(this.path)){const t=this.children.subtree(new bt(e));return t.isEmpty()?null:t.value?new yi(this.source,St(),t.value):new vi(this.source,St(),t)}return(0,I.hu)(Nt(this.path)===e,"Can't get a merge for a child not on the path of the operation"),new vi(this.source,xt(this.path),this.children)}toString(){return"Operation("+this.path+": "+this.source.toString()+" merge: "+this.children.toString()+")"}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function bi(e,t){return{eventCache:e,serverCache:t}}function Si(e,t,n,i){return bi(new Ci(t,n,i),e.serverCache)}function Ni(e,t,n,i){return bi(e.eventCache,new Ci(t,n,i))}function Pi(e){return e.eventCache.isFullyInitialized()?e.eventCache.getNode():null}function xi(e){return e.serverCache.isFullyInitialized()?e.serverCache.getNode():null}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let Ri;const Di=()=>(Ri||(Ri=new cn(Z)),Ri);class Mi{constructor(e,t=Di()){this.value=e,this.children=t}static fromObject(e){let t=new Mi(null);return ne(e,((e,n)=>{t=t.set(new bt(e),n)})),t}isEmpty(){return null===this.value&&this.children.isEmpty()}findRootMostMatchingPathAndValue(e,t){if(null!=this.value&&t(this.value))return{path:St(),value:this.value};if(Lt(e))return null;{const n=Nt(e),i=this.children.get(n);if(null!==i){const s=i.findRootMostMatchingPathAndValue(xt(e),t);if(null!=s){const e=At(new bt(n),s.path);return{path:e,value:s.value}}return null}return null}}findRootMostValueAndPath(e){return this.findRootMostMatchingPathAndValue(e,(()=>!0))}subtree(e){if(Lt(e))return this;{const t=Nt(e),n=this.children.get(t);return null!==n?n.subtree(xt(e)):new Mi(null)}}set(e,t){if(Lt(e))return new Mi(t,this.children);{const n=Nt(e),i=this.children.get(n)||new Mi(null),s=i.set(xt(e),t),r=this.children.insert(n,s);return new Mi(this.value,r)}}remove(e){if(Lt(e))return this.children.isEmpty()?new Mi(null):new Mi(null,this.children);{const t=Nt(e),n=this.children.get(t);if(n){const i=n.remove(xt(e));let s;return s=i.isEmpty()?this.children.remove(t):this.children.insert(t,i),null===this.value&&s.isEmpty()?new Mi(null):new Mi(this.value,s)}return this}}get(e){if(Lt(e))return this.value;{const t=Nt(e),n=this.children.get(t);return n?n.get(xt(e)):null}}setTree(e,t){if(Lt(e))return t;{const n=Nt(e),i=this.children.get(n)||new Mi(null),s=i.setTree(xt(e),t);let r;return r=s.isEmpty()?this.children.remove(n):this.children.insert(n,s),new Mi(this.value,r)}}fold(e){return this.fold_(St(),e)}fold_(e,t){const n={};return this.children.inorderTraversal(((i,s)=>{n[i]=s.fold_(At(e,i),t)})),t(e,this.value,n)}findOnPath(e,t){return this.findOnPath_(e,St(),t)}findOnPath_(e,t,n){const i=!!this.value&&n(t,this.value);if(i)return i;if(Lt(e))return null;{const i=Nt(e),s=this.children.get(i);return s?s.findOnPath_(xt(e),At(t,i),n):null}}foreachOnPath(e,t){return this.foreachOnPath_(e,St(),t)}foreachOnPath_(e,t,n){if(Lt(e))return this;{this.value&&n(t,this.value);const i=Nt(e),s=this.children.get(i);return s?s.foreachOnPath_(xt(e),At(t,i),n):new Mi(null)}}foreach(e){this.foreach_(St(),e)}foreach_(e,t){this.children.inorderTraversal(((n,i)=>{i.foreach_(At(e,n),t)})),this.value&&t(e,this.value)}foreachChild(e){this.children.inorderTraversal(((t,n)=>{n.value&&e(t,n.value)}))}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Fi{constructor(e){this.writeTree_=e}static empty(){return new Fi(new Mi(null))}}function Ai(e,t,n){if(Lt(t))return new Fi(new Mi(n));{const i=e.writeTree_.findRootMostValueAndPath(t);if(null!=i){const s=i.path;let r=i.value;const o=Ot(s,t);return r=r.updateChild(o,n),new Fi(e.writeTree_.set(s,r))}{const i=new Mi(n),s=e.writeTree_.setTree(t,i);return new Fi(s)}}}function Li(e,t,n){let i=e;return ne(n,((e,n)=>{i=Ai(i,At(t,e),n)})),i}function Oi(e,t){if(Lt(t))return Fi.empty();{const n=e.writeTree_.setTree(t,new Mi(null));return new Fi(n)}}function qi(e,t){return null!=Wi(e,t)}function Wi(e,t){const n=e.writeTree_.findRootMostValueAndPath(t);return null!=n?e.writeTree_.get(n.path).getChild(Ot(n.path,t)):null}function Ui(e){const t=[],n=e.writeTree_.value;return null!=n?n.isLeafNode()||n.forEachChild(En,((e,n)=>{t.push(new tn(e,n))})):e.writeTree_.children.inorderTraversal(((e,n)=>{null!=n.value&&t.push(new tn(e,n.value))})),t}function Bi(e,t){if(Lt(t))return e;{const n=Wi(e,t);return new Fi(null!=n?new Mi(n):e.writeTree_.subtree(t))}}function zi(e){return e.writeTree_.isEmpty()}function ji(e,t){return Hi(St(),e.writeTree_,t)}function Hi(e,t,n){if(null!=t.value)return n.updateChild(e,t.value);{let i=null;return t.children.inorderTraversal(((t,s)=>{".priority"===t?((0,I.hu)(null!==s.value,"Priority writes must always be leaf nodes"),i=s.value):n=Hi(At(e,t),s,n)})),n.getChild(e).isEmpty()||null===i||(n=n.updateChild(At(e,".priority"),i)),n}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Yi(e,t){return _s(t,e)}function Vi(e,t,n,i,s){(0,I.hu)(i>e.lastWriteId,"Stacking an older write on top of newer ones"),void 0===s&&(s=!0),e.allWrites.push({path:t,snap:n,writeId:i,visible:s}),s&&(e.visibleWrites=Ai(e.visibleWrites,t,n)),e.lastWriteId=i}function $i(e,t){for(let n=0;n<e.allWrites.length;n++){const i=e.allWrites[n];if(i.writeId===t)return i}return null}function Ki(e,t){const n=e.allWrites.findIndex((e=>e.writeId===t));(0,I.hu)(n>=0,"removeWrite called with nonexistent writeId.");const i=e.allWrites[n];e.allWrites.splice(n,1);let s=i.visible,r=!1,o=e.allWrites.length-1;while(s&&o>=0){const t=e.allWrites[o];t.visible&&(o>=n&&Gi(t,i.path)?s=!1:Wt(i.path,t.path)&&(r=!0)),o--}if(s){if(r)return Qi(e),!0;if(i.snap)e.visibleWrites=Oi(e.visibleWrites,i.path);else{const t=i.children;ne(t,(t=>{e.visibleWrites=Oi(e.visibleWrites,At(i.path,t))}))}return!0}return!1}function Gi(e,t){if(e.snap)return Wt(e.path,t);for(const n in e.children)if(e.children.hasOwnProperty(n)&&Wt(At(e.path,n),t))return!0;return!1}function Qi(e){e.visibleWrites=Zi(e.allWrites,Xi,St()),e.allWrites.length>0?e.lastWriteId=e.allWrites[e.allWrites.length-1].writeId:e.lastWriteId=-1}function Xi(e){return e.visible}function Zi(e,t,n){let i=Fi.empty();for(let s=0;s<e.length;++s){const r=e[s];if(t(r)){const e=r.path;let t;if(r.snap)Wt(n,e)?(t=Ot(n,e),i=Ai(i,t,r.snap)):Wt(e,n)&&(t=Ot(e,n),i=Ai(i,St(),r.snap.getChild(t)));else{if(!r.children)throw(0,I.g5)("WriteRecord should have .snap or .children");if(Wt(n,e))t=Ot(n,e),i=Li(i,t,r.children);else if(Wt(e,n))if(t=Ot(e,n),Lt(t))i=Li(i,St(),r.children);else{const e=(0,I.DV)(r.children,Nt(t));if(e){const n=e.getChild(xt(t));i=Ai(i,St(),n)}}}}}return i}function Ji(e,t,n,i,s){if(i||s){const r=Bi(e.visibleWrites,t);if(!s&&zi(r))return n;if(s||null!=n||qi(r,St())){const r=function(e){return(e.visible||s)&&(!i||!~i.indexOf(e.writeId))&&(Wt(e.path,t)||Wt(t,e.path))},o=Zi(e.allWrites,r,t),a=n||Dn.EMPTY_NODE;return ji(o,a)}return null}{const i=Wi(e.visibleWrites,t);if(null!=i)return i;{const i=Bi(e.visibleWrites,t);if(zi(i))return n;if(null!=n||qi(i,St())){const e=n||Dn.EMPTY_NODE;return ji(i,e)}return null}}}function es(e,t,n){let i=Dn.EMPTY_NODE;const s=Wi(e.visibleWrites,t);if(s)return s.isLeafNode()||s.forEachChild(En,((e,t)=>{i=i.updateImmediateChild(e,t)})),i;if(n){const s=Bi(e.visibleWrites,t);return n.forEachChild(En,((e,t)=>{const n=ji(Bi(s,new bt(e)),t);i=i.updateImmediateChild(e,n)})),Ui(s).forEach((e=>{i=i.updateImmediateChild(e.name,e.node)})),i}{const n=Bi(e.visibleWrites,t);return Ui(n).forEach((e=>{i=i.updateImmediateChild(e.name,e.node)})),i}}function ts(e,t,n,i,s){(0,I.hu)(i||s,"Either existingEventSnap or existingServerSnap must exist");const r=At(t,n);if(qi(e.visibleWrites,r))return null;{const t=Bi(e.visibleWrites,r);return zi(t)?s.getChild(n):ji(t,s.getChild(n))}}function ns(e,t,n,i){const s=At(t,n),r=Wi(e.visibleWrites,s);if(null!=r)return r;if(i.isCompleteForChild(n)){const t=Bi(e.visibleWrites,s);return ji(t,i.getNode().getImmediateChild(n))}return null}function is(e,t){return Wi(e.visibleWrites,t)}function ss(e,t,n,i,s,r,o){let a;const h=Bi(e.visibleWrites,t),l=Wi(h,St());if(null!=l)a=l;else{if(null==n)return[];a=ji(h,n)}if(a=a.withIndex(o),a.isEmpty()||a.isLeafNode())return[];{const e=[],t=o.getCompare(),n=r?a.getReverseIteratorFrom(i,o):a.getIteratorFrom(i,o);let h=n.getNext();while(h&&e.length<s)0!==t(h,i)&&e.push(h),h=n.getNext();return e}}function rs(){return{visibleWrites:Fi.empty(),allWrites:[],lastWriteId:-1}}function os(e,t,n,i){return Ji(e.writeTree,e.treePath,t,n,i)}function as(e,t){return es(e.writeTree,e.treePath,t)}function hs(e,t,n,i){return ts(e.writeTree,e.treePath,t,n,i)}function ls(e,t){return is(e.writeTree,At(e.treePath,t))}function cs(e,t,n,i,s,r){return ss(e.writeTree,e.treePath,t,n,i,s,r)}function us(e,t,n){return ns(e.writeTree,e.treePath,t,n)}function ds(e,t){return _s(At(e.treePath,t),e.writeTree)}function _s(e,t){return{treePath:e,writeTree:t}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class ps{constructor(){this.changeMap=new Map}trackChildChange(e){const t=e.type,n=e.childName;(0,I.hu)("child_added"===t||"child_changed"===t||"child_removed"===t,"Only child changes supported for tracking"),(0,I.hu)(".priority"!==n,"Only non-priority child changes can be tracked.");const i=this.changeMap.get(n);if(i){const s=i.type;if("child_added"===t&&"child_removed"===s)this.changeMap.set(n,Hn(n,e.snapshotNode,i.snapshotNode));else if("child_removed"===t&&"child_added"===s)this.changeMap.delete(n);else if("child_removed"===t&&"child_changed"===s)this.changeMap.set(n,jn(n,i.oldSnap));else if("child_changed"===t&&"child_added"===s)this.changeMap.set(n,zn(n,e.snapshotNode));else{if("child_changed"!==t||"child_changed"!==s)throw(0,I.g5)("Illegal combination of changes: "+e+" occurred after "+i);this.changeMap.set(n,Hn(n,e.snapshotNode,i.oldSnap))}}else this.changeMap.set(n,e)}getChanges(){return Array.from(this.changeMap.values())}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function ys(e){return{filter:e}}function vs(e,t){(0,I.hu)(t.eventCache.getNode().isIndexed(e.filter.getIndex()),"Event snap not indexed"),(0,I.hu)(t.serverCache.getNode().isIndexed(e.filter.getIndex()),"Server snap not indexed")}function Cs(e,t,n,i,s){const r=new ps;let o,a;if(n.type===_i.OVERWRITE){const h=n;h.source.fromUser?o=Es(e,t,h.path,h.snap,i,s,r):((0,I.hu)(h.source.fromServer,"Unknown source."),a=h.source.tagged||t.serverCache.isFiltered()&&!Lt(h.path),o=Is(e,t,h.path,h.snap,i,s,a,r))}else if(n.type===_i.MERGE){const h=n;h.source.fromUser?o=bs(e,t,h.path,h.children,i,s,r):((0,I.hu)(h.source.fromServer,"Unknown source."),a=h.source.tagged||t.serverCache.isFiltered(),o=Ns(e,t,h.path,h.children,i,s,a,r))}else if(n.type===_i.ACK_USER_WRITE){const a=n;o=a.revert?Rs(e,t,a.path,i,s,r):Ps(e,t,a.path,a.affectedTree,i,s,r)}else{if(n.type!==_i.LISTEN_COMPLETE)throw(0,I.g5)("Unknown operation type: "+n.type);o=xs(e,t,n.path,i,r)}const h=r.getChanges();return ws(t,o,h),{viewCache:o,changes:h}}function ws(e,t,n){const i=t.eventCache;if(i.isFullyInitialized()){const s=i.getNode().isLeafNode()||i.getNode().isEmpty(),r=Pi(e);(n.length>0||!e.eventCache.isFullyInitialized()||s&&!i.getNode().equals(r)||!i.getNode().getPriority().equals(r.getPriority()))&&n.push(Bn(Pi(t)))}}function Ts(e,t,n,i,s,r){const o=t.eventCache;if(null!=ls(i,n))return t;{let a,h;if(Lt(n))if((0,I.hu)(t.serverCache.isFullyInitialized(),"If change path is empty, we must have complete server data"),t.serverCache.isFiltered()){const n=xi(t),s=n instanceof Dn?n:Dn.EMPTY_NODE,o=as(i,s);a=e.filter.updateFullNode(t.eventCache.getNode(),o,r)}else{const n=os(i,xi(t));a=e.filter.updateFullNode(t.eventCache.getNode(),n,r)}else{const l=Nt(n);if(".priority"===l){(0,I.hu)(1===Pt(n),"Can't have a priority with additional path components");const s=o.getNode();h=t.serverCache.getNode();const r=hs(i,n,s,h);a=null!=r?e.filter.updatePriority(s,r):o.getNode()}else{const c=xt(n);let u;if(o.isCompleteForChild(l)){h=t.serverCache.getNode();const e=hs(i,n,o.getNode(),h);u=null!=e?o.getNode().getImmediateChild(l).updateChild(c,e):o.getNode().getImmediateChild(l)}else u=us(i,l,t.serverCache);a=null!=u?e.filter.updateChild(o.getNode(),l,u,c,s,r):o.getNode()}}return Si(t,a,o.isFullyInitialized()||Lt(n),e.filter.filtersNodes())}}function Is(e,t,n,i,s,r,o,a){const h=t.serverCache;let l;const c=o?e.filter:e.filter.getIndexedFilter();if(Lt(n))l=c.updateFullNode(h.getNode(),i,null);else if(c.filtersNodes()&&!h.isFiltered()){const e=h.getNode().updateChild(n,i);l=c.updateFullNode(h.getNode(),e,null)}else{const e=Nt(n);if(!h.isCompleteForPath(n)&&Pt(n)>1)return t;const s=xt(n),r=h.getNode().getImmediateChild(e),o=r.updateChild(s,i);l=".priority"===e?c.updatePriority(h.getNode(),o):c.updateChild(h.getNode(),e,o,s,ms,null)}const u=Ni(t,l,h.isFullyInitialized()||Lt(n),c.filtersNodes()),d=new gs(s,u,r);return Ts(e,u,n,s,d,a)}function Es(e,t,n,i,s,r,o){const a=t.eventCache;let h,l;const c=new gs(s,t,r);if(Lt(n))l=e.filter.updateFullNode(t.eventCache.getNode(),i,o),h=Si(t,l,!0,e.filter.filtersNodes());else{const s=Nt(n);if(".priority"===s)l=e.filter.updatePriority(t.eventCache.getNode(),i),h=Si(t,l,a.isFullyInitialized(),a.isFiltered());else{const r=xt(n),l=a.getNode().getImmediateChild(s);let u;if(Lt(r))u=i;else{const e=c.getCompleteChild(s);u=null!=e?".priority"===Rt(r)&&e.getChild(Ft(r)).isEmpty()?e:e.updateChild(r,i):Dn.EMPTY_NODE}if(l.equals(u))h=t;else{const n=e.filter.updateChild(a.getNode(),s,u,r,c,o);h=Si(t,n,a.isFullyInitialized(),e.filter.filtersNodes())}}}return h}function ks(e,t){return e.eventCache.isCompleteForChild(t)}function bs(e,t,n,i,s,r,o){let a=t;return i.foreach(((i,h)=>{const l=At(n,i);ks(t,Nt(l))&&(a=Es(e,a,l,h,s,r,o))})),i.foreach(((i,h)=>{const l=At(n,i);ks(t,Nt(l))||(a=Es(e,a,l,h,s,r,o))})),a}function Ss(e,t,n){return n.foreach(((e,n)=>{t=t.updateChild(e,n)})),t}function Ns(e,t,n,i,s,r,o,a){if(t.serverCache.getNode().isEmpty()&&!t.serverCache.isFullyInitialized())return t;let h,l=t;h=Lt(n)?i:new Mi(null).setTree(n,i);const c=t.serverCache.getNode();return h.children.inorderTraversal(((n,i)=>{if(c.hasChild(n)){const h=t.serverCache.getNode().getImmediateChild(n),c=Ss(e,h,i);l=Is(e,l,new bt(n),c,s,r,o,a)}})),h.children.inorderTraversal(((n,i)=>{const h=!t.serverCache.isCompleteForChild(n)&&void 0===i.value;if(!c.hasChild(n)&&!h){const h=t.serverCache.getNode().getImmediateChild(n),c=Ss(e,h,i);l=Is(e,l,new bt(n),c,s,r,o,a)}})),l}function Ps(e,t,n,i,s,r,o){if(null!=ls(s,n))return t;const a=t.serverCache.isFiltered(),h=t.serverCache;if(null!=i.value){if(Lt(n)&&h.isFullyInitialized()||h.isCompleteForPath(n))return Is(e,t,n,h.getNode().getChild(n),s,r,a,o);if(Lt(n)){let i=new Mi(null);return h.getNode().forEachChild(on,((e,t)=>{i=i.set(new bt(e),t)})),Ns(e,t,n,i,s,r,a,o)}return t}{let l=new Mi(null);return i.foreach(((e,t)=>{const i=At(n,e);h.isCompleteForPath(i)&&(l=l.set(e,h.getNode().getChild(i)))})),Ns(e,t,n,l,s,r,a,o)}}function xs(e,t,n,i,s){const r=t.serverCache,o=Ni(t,r.getNode(),r.isFullyInitialized()||Lt(n),r.isFiltered());return Ts(e,o,n,i,ms,s)}function Rs(e,t,n,i,s,r){let o;if(null!=ls(i,n))return t;{const a=new gs(i,t,s),h=t.eventCache.getNode();let l;if(Lt(n)||".priority"===Nt(n)){let n;if(t.serverCache.isFullyInitialized())n=os(i,xi(t));else{const e=t.serverCache.getNode();(0,I.hu)(e instanceof Dn,"serverChildren would be complete if leaf node"),n=as(i,e)}l=e.filter.updateFullNode(h,n,r)}else{const s=Nt(n);let c=us(i,s,t.serverCache);null==c&&t.serverCache.isCompleteForChild(s)&&(c=h.getImmediateChild(s)),l=null!=c?e.filter.updateChild(h,s,c,xt(n),a,r):t.eventCache.getNode().hasChild(s)?e.filter.updateChild(h,s,Dn.EMPTY_NODE,xt(n),a,r):h,l.isEmpty()&&t.serverCache.isFullyInitialized()&&(o=os(i,xi(t)),o.isLeafNode()&&(l=e.filter.updateFullNode(l,o,r)))}return o=t.serverCache.isFullyInitialized()||null!=ls(i,St()),Si(t,l,o,e.filter.filtersNodes())}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let Os,qs;class Ws{constructor(){this.views=new Map}}function Us(e){(0,I.hu)(!Os,"__referenceConstructor has already been defined"),Os=e}function Bs(e,t,n,i){const s=t.source.queryId;if(null!==s){const r=e.views.get(s);return(0,I.hu)(null!=r,"SyncTree gave us an op for an invalid query."),As(r,t,n,i)}{let s=[];for(const r of e.views.values())s=s.concat(As(r,t,n,i));return s}}function zs(e,t,n,i,s){const r=t._queryIdentifier,o=e.views.get(r);if(!o){let e=os(n,s?i:null),r=!1;e?r=!0:i instanceof Dn?(e=as(n,i),r=!1):(e=Dn.EMPTY_NODE,r=!1);const o=bi(new Ci(e,r,!1),new Ci(i,s,!1));return new Ds(t,o)}return o}function js(e,t){let n=null;for(const i of e.views.values())n=n||Fs(i,t);return n}function Hs(e){(0,I.hu)(!qs,"__referenceConstructor has already been defined"),qs=e}class Ys{constructor(e){this.listenProvider_=e,this.syncPointTree_=new Mi(null),this.pendingWriteTree_=rs(),this.tagToQueryMap=new Map,this.queryToTagMap=new Map}}function Vs(e,t,n,i,s){return Vi(e.pendingWriteTree_,t,n,i,s),s?er(e,new yi(pi(),t,n)):[]}function $s(e,t,n=!1){const i=$i(e.pendingWriteTree_,t),s=Ki(e.pendingWriteTree_,t);if(s){let t=new Mi(null);return null!=i.snap?t=t.set(St(),!0):ne(i.children,(e=>{t=t.set(new bt(e),!0)})),er(e,new gi(i.path,t,n))}return[]}function Ks(e,t,n){return er(e,new yi(fi(),t,n))}function Gs(e,t,n){const i=Mi.fromObject(n);return er(e,new vi(fi(),t,i))}function Qs(e,t,n,i){const s=ir(e,i);if(null!=s){const i=sr(s),r=i.path,o=i.queryId,a=Ot(r,t),h=new yi(mi(o),a,n);return rr(e,r,h)}return[]}function Xs(e,t,n,i){const s=ir(e,i);if(s){const i=sr(s),r=i.path,o=i.queryId,a=Ot(r,t),h=Mi.fromObject(n),l=new vi(mi(o),a,h);return rr(e,r,l)}return[]}function Zs(e,t,n){const i=!0,s=e.pendingWriteTree_,r=e.syncPointTree_.findOnPath(t,((e,n)=>{const i=Ot(e,t),s=js(n,i);if(s)return s}));return Ji(s,t,r,n,i)}function Js(e,t){const n=t._path;let i=null;e.syncPointTree_.foreachOnPath(n,((e,t)=>{const s=Ot(e,n);i=i||js(t,s)}));let s=e.syncPointTree_.get(n);s?i=i||js(s,St()):(s=new Ws,e.syncPointTree_=e.syncPointTree_.set(n,s));const r=null!=i,o=r?new Ci(i,!0,!1):null,a=Yi(e.pendingWriteTree_,t._path),h=zs(s,t,a,r?o.getNode():Dn.EMPTY_NODE,r);return Ms(h)}function er(e,t){return tr(t,e.syncPointTree_,null,Yi(e.pendingWriteTree_,St()))}function tr(e,t,n,i){if(Lt(e.path))return nr(e,t,n,i);{const s=t.get(St());null==n&&null!=s&&(n=js(s,St()));let r=[];const o=Nt(e.path),a=e.operationForChild(o),h=t.children.get(o);if(h&&a){const e=n?n.getImmediateChild(o):null,t=ds(i,o);r=r.concat(tr(a,h,e,t))}return s&&(r=r.concat(Bs(s,e,i,n))),r}}function nr(e,t,n,i){const s=t.get(St());null==n&&null!=s&&(n=js(s,St()));let r=[];return t.children.inorderTraversal(((t,s)=>{const o=n?n.getImmediateChild(t):null,a=ds(i,t),h=e.operationForChild(t);h&&(r=r.concat(nr(h,s,o,a)))})),s&&(r=r.concat(Bs(s,e,i,n))),r}function ir(e,t){return e.tagToQueryMap.get(t)}function sr(e){const t=e.indexOf("$");return(0,I.hu)(-1!==t&&t<e.length-1,"Bad queryKey."),{queryId:e.substr(t+1),path:new bt(e.substr(0,t))}}function rr(e,t,n){const i=e.syncPointTree_.get(t);(0,I.hu)(i,"Missing sync point for query tag that we're tracking");const s=Yi(e.pendingWriteTree_,t);return Bs(i,n,s,null)}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Sr=/[\[\].#$\/\u0000-\u001F\u007F]/,Nr=/[\[\].#$\u0000-\u001F\u007F]/,Pr=10485760,xr=function(e){return"string"===typeof e&&0!==e.length&&!Sr.test(e)},Rr=function(e){return"string"===typeof e&&0!==e.length&&!Nr.test(e)},Dr=function(e){return e&&(e=e.replace(/^\/*\.info(\/|$)/,"/")),Rr(e)},Mr=function(e){return null===e||"string"===typeof e||"number"===typeof e&&!$(e)||e&&"object"===typeof e&&(0,I.r3)(e,".sv")},Fr=function(e,t,n,i){i&&void 0===t||Ar((0,I.gK)(e,"value"),t,n)},Ar=function(e,t,n){const i=n instanceof bt?new Ut(n,e):n;if(void 0===t)throw new Error(e+"contains undefined "+Ht(i));if("function"===typeof t)throw new Error(e+"contains a function "+Ht(i)+" with contents = "+t.toString());if($(t))throw new Error(e+"contains "+t.toString()+" "+Ht(i));if("string"===typeof t&&t.length>Pr/3&&(0,I.ug)(t)>Pr)throw new Error(e+"contains a string greater than "+Pr+" utf8 bytes "+Ht(i)+" ('"+t.substring(0,50)+"...')");if(t&&"object"===typeof t){let n=!1,s=!1;if(ne(t,((t,r)=>{if(".value"===t)n=!0;else if(".priority"!==t&&".sv"!==t&&(s=!0,!xr(t)))throw new Error(e+" contains an invalid key ("+t+") "+Ht(i)+'.  Keys must be non-empty strings and can\'t contain ".", "#", "$", "/", "[", or "]"');Bt(i,t),Ar(e,r,i),zt(i)})),n&&s)throw new Error(e+' contains ".value" child '+Ht(i)+" in addition to actual children.")}},Lr=function(e,t,n,i){if((!i||void 0!==n)&&!xr(n))throw new Error((0,I.gK)(e,t)+'was an invalid key = "'+n+'".  Firebase keys must be non-empty strings and can\'t contain ".", "#", "$", "/", "[", or "]").')},Or=function(e,t,n,i){if((!i||void 0!==n)&&!Rr(n))throw new Error((0,I.gK)(e,t)+'was an invalid path = "'+n+'". Paths must be non-empty strings and can\'t contain ".", "#", "$", "[", or "]"')},qr=function(e,t,n,i){n&&(n=n.replace(/^\/*\.info(\/|$)/,"/")),Or(e,t,n,i)},Wr=function(e,t){const n=t.path.toString();if("string"!==typeof t.repoInfo.host||0===t.repoInfo.host.length||!xr(t.repoInfo.namespace)&&"localhost"!==t.repoInfo.host.split(":")[0]||0!==n.length&&!Dr(n))throw new Error((0,I.gK)(e,"url")+'must be a valid firebase URL and the path can\'t contain ".", "#", "$", "[", or "]".')};
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * limitations under the License.
 */
class Ur{constructor(){this.eventLists_=[],this.recursionDepth_=0}}function Br(e,t){let n=null;for(let i=0;i<t.length;i++){const s=t[i],r=s.getPath();null===n||qt(r,n.path)||(e.eventLists_.push(n),n=null),null===n&&(n={events:[],path:r}),n.events.push(s)}n&&e.eventLists_.push(n)}function zr(e,t,n){Br(e,n),Hr(e,(e=>qt(e,t)))}function jr(e,t,n){Br(e,n),Hr(e,(e=>Wt(e,t)||Wt(t,e)))}function Hr(e,t){e.recursionDepth_++;let n=!0;for(let i=0;i<e.eventLists_.length;i++){const s=e.eventLists_[i];if(s){const r=s.path;t(r)?(Yr(e.eventLists_[i]),e.eventLists_[i]=null):n=!1}}n&&(e.eventLists_=[]),e.recursionDepth_--}function Yr(e){for(let t=0;t<e.events.length;t++){const n=e.events[t];if(null!==n){e.events[t]=null;const i=n.getEventRunner();q&&B("event: "+n.toString()),ce(i)}}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * limitations under the License.
 */
class Io{constructor(e,t,n,i){this._repo=e,this._path=t,this._queryParams=n,this._orderByCalled=i}get key(){return Lt(this._path)?null:Rt(this._path)}get ref(){return new So(this._repo,this._path)}get _queryIdentifier(){const e=ti(this._queryParams),t=ee(e);return"{}"===t?"default":t}get _queryObject(){return ti(this._queryParams)}isEqual(e){if(e=(0,I.m9)(e),!(e instanceof Io))return!1;const t=this._repo===e._repo,n=qt(this._path,e._path),i=this._queryIdentifier===e._queryIdentifier;return t&&n&&i}toJSON(){return this.toString()}toString(){return this._repo.toString()+Dt(this._path)}}function Eo(e,t){if(!0===e._orderByCalled)throw new Error(t+": You can't combine multiple orderBy calls.")}function ko(e){let t=null,n=null;if(e.hasStart()&&(t=e.getIndexStartValue()),e.hasEnd()&&(n=e.getIndexEndValue()),e.getIndex()===on){const i="Query: When ordering by key, you may only pass one argument to startAt(), endAt(), or equalTo().",s="Query: When ordering by key, the argument passed to startAt(), startAfter(), endAt(), endBefore(), or equalTo() must be a string.";if(e.hasStart()){const n=e.getIndexStartName();if(n!==G)throw new Error(i);if("string"!==typeof t)throw new Error(s)}if(e.hasEnd()){const t=e.getIndexEndName();if(t!==Q)throw new Error(i);if("string"!==typeof n)throw new Error(s)}}else if(e.getIndex()===En){if(null!=t&&!Mr(t)||null!=n&&!Mr(n))throw new Error("Query: When ordering by priority, the first argument passed to startAt(), startAfter() endAt(), endBefore(), or equalTo() must be a valid priority value (null, a number, or a string).")}else if((0,I.hu)(e.getIndex()instanceof On||e.getIndex()===Wn,"unknown index type."),null!=t&&"object"===typeof t||null!=n&&"object"===typeof n)throw new Error("Query: First argument passed to startAt(), startAfter(), endAt(), endBefore(), or equalTo() cannot be an object.")}function bo(e){if(e.hasStart()&&e.hasEnd()&&e.hasLimit()&&!e.hasAnchoredLimit())throw new Error("Query: Can't combine startAt(), startAfter(), endAt(), endBefore(), and limit(). Use limitToFirst() or limitToLast() instead.")}class So extends Io{constructor(e,t){super(e,t,new Gn,!1)}get parent(){const e=Ft(this._path);return null===e?null:new So(this._repo,e)}get root(){let e=this;while(null!==e.parent)e=e.parent;return e}}class No{constructor(e,t,n){this._node=e,this.ref=t,this._index=n}get priority(){return this._node.getPriority().val()}get key(){return this.ref.key}get size(){return this._node.numChildren()}child(e){const t=new bt(e),n=xo(this.ref,e);return new No(this._node.getChild(t),n,En)}exists(){return!this._node.isEmpty()}exportVal(){return this._node.val(!0)}forEach(e){if(this._node.isLeafNode())return!1;const t=this._node;return!!t.forEachChild(this._index,((t,n)=>e(new No(n,xo(this.ref,t),En))))}hasChild(e){const t=new bt(e);return!this._node.getChild(t).isEmpty()}hasChildren(){return!this._node.isLeafNode()&&!this._node.isEmpty()}toJSON(){return this.exportVal()}val(){return this._node.val()}}function Po(e,t){return e=(0,I.m9)(e),e._checkNotDeleted("ref"),void 0!==t?xo(e._root,t):e._root}function xo(e,t){return e=(0,I.m9)(e),null===Nt(e._path)?qr("child","path",t,!1):Or("child","path",t,!1),new So(e._repo,At(e._path,t))}function Ro(e){return e=(0,I.m9)(e),io(e._repo,e).then((t=>new No(t,new So(e._repo,e._path),e._queryParams.getIndex())))}class Do{}class Mo extends Do{constructor(e,t){super(),this._value=e,this._key=t}_apply(e){Fr("endAt",this._value,e._path,!0);const t=Zn(e._queryParams,this._value,this._key);if(bo(t),ko(t),e._queryParams.hasEnd())throw new Error("endAt: Starting point was already set (by another call to endAt, endBefore or equalTo).");return new Io(e._repo,e._path,t,e._orderByCalled)}}class Fo extends Do{constructor(e,t){super(),this._value=e,this._key=t}_apply(e){Fr("startAt",this._value,e._path,!0);const t=Xn(e._queryParams,this._value,this._key);if(bo(t),ko(t),e._queryParams.hasStart())throw new Error("startAt: Starting point was already set (by another call to startAt, startBefore or equalTo).");return new Io(e._repo,e._path,t,e._orderByCalled)}}class Ao extends Do{constructor(e){super(),this._path=e}_apply(e){Eo(e,"orderByChild");const t=new bt(this._path);if(Lt(t))throw new Error("orderByChild: cannot pass in empty path. Use orderByValue() instead.");const n=new On(t),i=Jn(e._queryParams,n);return ko(i),new Io(e._repo,e._path,i,!0)}}function Lo(e){if("$key"===e)throw new Error('orderByChild: "$key" is invalid.  Use orderByKey() instead.');if("$priority"===e)throw new Error('orderByChild: "$priority" is invalid.  Use orderByPriority() instead.');if("$value"===e)throw new Error('orderByChild: "$value" is invalid.  Use orderByValue() instead.');return Or("orderByChild","path",e,!1),new Ao(e)}class Oo extends Do{constructor(e,t){super(),this._value=e,this._key=t}_apply(e){if(Fr("equalTo",this._value,e._path,!1),e._queryParams.hasStart())throw new Error("equalTo: Starting point was already set (by another call to startAt/startAfter or equalTo).");if(e._queryParams.hasEnd())throw new Error("equalTo: Ending point was already set (by another call to endAt/endBefore or equalTo).");return new Mo(this._value,this._key)._apply(new Fo(this._value,this._key)._apply(e))}}function qo(e,t){return Lr("equalTo","key",t,!0),new Oo(e,t)}function Wo(e,...t){let n=(0,I.m9)(e);for(const i of t)n=i._apply(n);return n}Us(So),Hs(So);
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * limitations under the License.
 */
const Uo="FIREBASE_DATABASE_EMULATOR_HOST",Bo={};let zo=!1;function jo(e,t,n,i,s){let r=i||e.options.databaseURL;void 0===r&&(e.options.projectId||H("Can't determine Firebase Database URL. Be sure to include  a Project ID when calling firebase.initializeApp()."),B("Using default host for project ",e.options.projectId),r=`${e.options.projectId}-default-rtdb.firebaseio.com`);let o,a,h=wo(r,s),l=h.repoInfo;"undefined"!==typeof process&&(a={NODE_ENV:"production",BASE_URL:"/baemin_proj/"}[Uo]),a?(o=!0,r=`http://${a}?ns=${l.namespace}`,h=wo(r,s),l=h.repoInfo):o=!h.repoInfo.secure;const c=s&&o?new fe(fe.OWNER):new pe(e.name,e.options,t);Wr("Invalid Firebase Database URL",h),Lt(h.path)||H("Database URL must point to the root of a Firebase Database (not including a child path).");const u=Yo(l,e,c,new _e(e.name,n));return new Vo(u,e)}function Ho(e,t){const n=Bo[t];n&&n[e.key]===e||H(`Database ${t}(${e.repoInfo_}) has already been deleted.`),ro(e),delete n[e.key]}function Yo(e,t,n,i){let s=Bo[t.name];s||(s={},Bo[t.name]=s);let r=s[e.toURLString()];return r&&H("Database initialized multiple times. Please make sure the format of the database URL matches with each database() call."),r=new Kr(e,zo,n,i),s[e.toURLString()]=r,r}class Vo{constructor(e,t){this._repoInternal=e,this.app=t,this["type"]="database",this._instanceStarted=!1}get _repo(){return this._instanceStarted||(Gr(this._repoInternal,this.app.options.appId,this.app.options["databaseAuthVariableOverride"]),this._instanceStarted=!0),this._repoInternal}get _root(){return this._rootInternal||(this._rootInternal=new So(this._repo,St())),this._rootInternal}_delete(){return null!==this._rootInternal&&(Ho(this._repo,this.app.name),this._repoInternal=null,this._rootInternal=null),Promise.resolve()}_checkNotDeleted(e){null===this._rootInternal&&H("Cannot call "+e+" on a deleted database.")}}function $o(e=(0,w.Mq)(),t){return(0,w.qX)(e,"database").getImmediate({identifier:t})}
/**
 * @license
 * Copyright 2021 Google LLC
 *
 ...
 * limitations under the License.
 */
function Ko(e){N(w.Jn),(0,w.Xd)(new T.wA("database",((e,{instanceIdentifier:t})=>{const n=e.getProvider("app").getImmediate(),i=e.getProvider("auth-internal"),s=e.getProvider("app-check-internal");return jo(n,i,s,t)}),"PUBLIC").setMultipleInstances(!0)),(0,w.KN)(k,b,e),(0,w.KN)(k,b,"esm2017")}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */en.prototype.simpleListen=function(e,t){this.sendRequest("q",{p:e},t)},en.prototype.echo=function(e,t){this.sendRequest("echo",{d:e},t)};Ko();class Go{constructor(){(0,_.Z)(this,"app",void 0),(0,_.Z)(this,"realtimeDB",void 0),this.app=(0,C.Mq)(),this.realtimeDB=$o(this.app)}getFoodShopFilterByAddress(e){return Ro(Wo(Po(this.realtimeDB,"DATA"),Lo("cgg_code_nm"),qo(e))).then((e=>e.exists()?e.val():(console.warn("No data available"),[]))).catch((e=>{console.error(`[getFoodShopFilterByAddress] error: ${e.message}`)}))}}var Qo=n(3419),Xo=n(4060),Zo=(0,i.aZ)({name:"AddressSelectBtn",components:{AddressModal:v},props:{address:String,color:String},data(){return{addrStr:this.address,region_2depth_name:"",dispatch:(0,Qo.H)()}},mounted(){this.loadLastLocation(),this.loadFilteredStoreList(this.region_2depth_name)},methods:{onArrowBtnClicked(){this.$refs.addressModalComponent.showModal()},saveLastLocation(e,t){localStorage.setItem("addressFull",e),localStorage.setItem("region_2depth_name",t)},loadLastLocation(){this.addrStr=localStorage.getItem("addressFull")||"서울 송파구 방이동",this.region_2depth_name=localStorage.getItem("region_2depth_name")||"송파구",console.log("add",this.addrStr,this.region_2depth_name)},loadFilteredStoreList(e){const t=new Go;t.getFoodShopFilterByAddress(e).then((e=>{console.log("test",e),this.dispatch((0,Xo.qc)({storeListData:e}))}))},onAddressLoaded(e){console.log("addressInfo",e),this.loadFilteredStoreList(e.region_2depth_name),this.addrStr=`${e.region_1depth_name} ${e.region_2depth_name} ${e.region_3depth_name}`,this.saveLastLocation(this.addrStr,e.region_2depth_name)}}});const Jo=(0,g.Z)(Zo,[["render",r],["__scopeId","data-v-22662ffc"]]);var ea=Jo}}]);
//# sourceMappingURL=270.c74a8207.js.map