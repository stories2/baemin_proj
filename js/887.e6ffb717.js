 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class L{constructor(){this.cache_={},this.isInMemoryStorage=!0}set(e,t){null==t?delete this.cache_[e]:this.cache_[e]=t}get(e){return(0,b.r3)(this.cache_,e)?this.cache_[e]:null}remove(e){delete this.cache_[e]}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Le{constructor(){this.counters_={}}incrementCounter(e,t=1){(0,b.r3)(this.counters_,e)||(this.counters_[e]=0),this.counters_[e]+=t}get(){return(0,b.p$)(this.counters_)}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const De={},Oe={};function Ae(e){const t=e.toString();return De[t]||(De[t]=new Le),De[t]}function Fe(e,t){const n=e.toString();return Oe[n]||(Oe[n]=t()),Oe[n]}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let Rn;const Mn={};class Ln{constructor(e,t){this.indexes_=e,this.indexSet_=t}static get Default(){return(0,b.hu)(Mn&&Sn,"ChildrenNode.ts has not been loaded"),Rn=Rn||new Ln({".priority":Mn},{".priority":Sn}),Rn}get(e){const t=(0,b.DV)(this.indexes_,e);if(!t)throw new Error("No index defined for "+e);return t instanceof _n?t:null}hasIndex(e){return(0,b.r3)(this.indexSet_,e.toString())}addIndex(e,t){(0,b.hu)(e!==hn,"KeyIndex always exists and isn't meant to be added to the IndexMap.");const n=[];let i=!1;const s=t.getIterator(rn.Wrap);let r,o=s.getNext();while(o)i=i||e.isDefinedOn(o.node),n.push(o),o=s.getNext();r=i?Pn(n,e.getCompare()):Mn;const a=e.toString(),l=Object.assign({},this.indexSet_);l[a]=e;const h=Object.assign({},this.indexes_);return h[a]=r,new Ln(h,l)}addToIndexes(e,t){const n=(0,b.UI)(this.indexes_,((n,i)=>{const s=(0,b.DV)(this.indexSet_,i);if((0,b.hu)(s,"Missing index implementation for "+i),n===Mn){if(s.isDefinedOn(e.node)){const n=[],i=t.getIterator(rn.Wrap);let r=i.getNext();while(r)r.name!==e.name&&n.push(r),r=i.getNext();return n.push(e),Pn(n,s.getCompare())}return Mn}{const i=t.get(e.name);let s=n;return i&&(s=s.remove(new rn(e.name,i))),s.insert(e,e.node)}}));return new Ln(n,this.indexSet_)}removeFromIndexes(e,t){const n=(0,b.UI)(this.indexes_,(n=>{if(n===Mn)return n;{const i=t.get(e.name);return i?n.remove(new rn(e.name,i)):n}}));return new Ln(n,this.indexSet_)}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * limitations under the License.
 */
class wi{constructor(e,t,n){this.source=e,this.path=t,this.snap=n,this.type=mi.OVERWRITE}operationForChild(e){return Ut(this.path)?new wi(this.source,Pt(),this.snap.getImmediateChild(e)):new wi(this.source,Lt(this.path),this.snap)}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function xi(e,t){return{eventCache:e,serverCache:t}}function Pi(e,t,n,i){return xi(new Ii(t,n,i),e.serverCache)}function Ri(e,t,n,i){return xi(e.eventCache,new Ii(t,n,i))}function Mi(e){return e.eventCache.isFullyInitialized()?e.eventCache.getNode():null}function Li(e){return e.serverCache.isFullyInitialized()?e.serverCache.getNode():null}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let Di;const Oi=()=>(Di||(Di=new _n(te)),Di);class Ai{constructor(e,t=Oi()){this.value=e,this.children=t}static fromObject(e){let t=new Ai(null);return re(e,((e,n)=>{t=t.set(new xt(e),n)})),t}isEmpty(){return null===this.value&&this.children.isEmpty()}findRootMostMatchingPathAndValue(e,t){if(null!=this.value&&t(this.value))return{path:Pt(),value:this.value};if(Ut(e))return null;{const n=Rt(e),i=this.children.get(n);if(null!==i){const s=i.findRootMostMatchingPathAndValue(Lt(e),t);if(null!=s){const e=qt(new xt(n),s.path);return{path:e,value:s.value}}return null}return null}}findRootMostValueAndPath(e){return this.findRootMostMatchingPathAndValue(e,(()=>!0))}subtree(e){if(Ut(e))return this;{const t=Rt(e),n=this.children.get(t);return null!==n?n.subtree(Lt(e)):new Ai(null)}}set(e,t){if(Ut(e))return new Ai(t,this.children);{const n=Rt(e),i=this.children.get(n)||new Ai(null),s=i.set(Lt(e),t),r=this.children.insert(n,s);return new Ai(this.value,r)}}remove(e){if(Ut(e))return this.children.isEmpty()?new Ai(null):new Ai(null,this.children);{const t=Rt(e),n=this.children.get(t);if(n){const i=n.remove(Lt(e));let s;return s=i.isEmpty()?this.children.remove(t):this.children.insert(t,i),null===this.value&&s.isEmpty()?new Ai(null):new Ai(this.value,s)}return this}}get(e){if(Ut(e))return this.value;{const t=Rt(e),n=this.children.get(t);return n?n.get(Lt(e)):null}}setTree(e,t){if(Ut(e))return t;{const n=Rt(e),i=this.children.get(n)||new Ai(null),s=i.setTree(Lt(e),t);let r;return r=s.isEmpty()?this.children.remove(n):this.children.insert(n,s),new Ai(this.value,r)}}fold(e){return this.fold_(Pt(),e)}fold_(e,t){const n={};return this.children.inorderTraversal(((i,s)=>{n[i]=s.fold_(qt(e,i),t)})),t(e,this.value,n)}findOnPath(e,t){return this.findOnPath_(e,Pt(),t)}findOnPath_(e,t,n){const i=!!this.value&&n(t,this.value);if(i)return i;if(Ut(e))return null;{const i=Rt(e),s=this.children.get(i);return s?s.findOnPath_(Lt(e),qt(t,i),n):null}}foreachOnPath(e,t){return this.foreachOnPath_(e,Pt(),t)}foreachOnPath_(e,t,n){if(Ut(e))return this;{this.value&&n(t,this.value);const i=Rt(e),s=this.children.get(i);return s?s.foreachOnPath_(Lt(e),qt(t,i),n):new Ai(null)}}foreach(e){this.foreach_(Pt(),e)}foreach_(e,t){this.children.inorderTraversal(((n,i)=>{i.foreach_(qt(e,n),t)})),this.value&&t(e,this.value)}foreachChild(e){this.children.inorderTraversal(((t,n)=>{n.value&&e(t,n.value)}))}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class ys{getCompleteChild(e){return null}getChildAfterChild(e,t,n){return null}}const vs=new ys;class Cs{constructor(e,t,n=null){this.writes_=e,this.viewCache_=t,this.optCompleteServerCache_=n}getCompleteChild(e){const t=this.viewCache_.eventCache;if(t.isCompleteForChild(e))return t.getNode().getImmediateChild(e);{const t=null!=this.optCompleteServerCache_?new Ii(this.optCompleteServerCache_,!0,!1):this.viewCache_.serverCache;return ps(this.writes_,e,t)}}getChildAfterChild(e,t,n){const i=null!=this.optCompleteServerCache_?this.optCompleteServerCache_:Li(this.viewCache_),s=_s(this.writes_,i,t,1,n,e);return 0===s.length?null:s[0]}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Pr=/[\[\].#$\/\u0000-\u001F\u007F]/,Rr=/[\[\].#$\u0000-\u001F\u007F]/,Mr=10485760,Lr=function(e){return"string"===typeof e&&0!==e.length&&!Pr.test(e)},Dr=function(e){return"string"===typeof e&&0!==e.length&&!Rr.test(e)},Or=function(e){return e&&(e=e.replace(/^\/*\.info(\/|$)/,"/")),Dr(e)},Ar=function(e){return null===e||"string"===typeof e||"number"===typeof e&&!Q(e)||e&&"object"===typeof e&&(0,b.r3)(e,".sv")},Fr=function(e,t,n,i){i&&void 0===t||qr((0,b.gK)(e,"value"),t,n)},qr=function(e,t,n){const i=n instanceof xt?new Vt(n,e):n;if(void 0===t)throw new Error(e+"contains undefined "+Kt(i));if("function"===typeof t)throw new Error(e+"contains a function "+Kt(i)+" with contents = "+t.toString());if(Q(t))throw new Error(e+"contains "+t.toString()+" "+Kt(i));if("string"===typeof t&&t.length>Mr/3&&(0,b.ug)(t)>Mr)throw new Error(e+"contains a string greater than "+Mr+" utf8 bytes "+Kt(i)+" ('"+t.substring(0,50)+"...')");if(t&&"object"===typeof t){let n=!1,s=!1;if(re(t,((t,r)=>{if(".value"===t)n=!0;else if(".priority"!==t&&".sv"!==t&&(s=!0,!Lr(t)))throw new Error(e+" contains an invalid key ("+t+") "+Kt(i)+'.  Keys must be non-empty strings and can\'t contain ".", "#", "$", "/", "[", or "]"');jt(i,t),qr(e,r,i),Ht(i)})),n&&s)throw new Error(e+' contains ".value" child '+Kt(i)+" in addition to actual children.")}},Ur=function(e,t,n,i){if((!i||void 0!==n)&&!Lr(n))throw new Error((0,b.gK)(e,t)+'was an invalid key = "'+n+'".  Firebase keys must be non-empty strings and can\'t contain ".", "#", "$", "/", "[", or "]").')},Wr=function(e,t,n,i){if((!i||void 0!==n)&&!Dr(n))throw new Error((0,b.gK)(e,t)+'was an invalid path = "'+n+'". Paths must be non-empty strings and can\'t contain ".", "#", "$", "[", or "]"')},Br=function(e,t,n,i){n&&(n=n.replace(/^\/*\.info(\/|$)/,"/")),Wr(e,t,n,i)},zr=function(e,t){const n=t.path.toString();if("string"!==typeof t.repoInfo.host||0===t.repoInfo.host.length||!Lr(t.repoInfo.namespace)&&"localhost"!==t.repoInfo.host.split(":")[0]||0!==n.length&&!Or(n))throw new Error((0,b.gK)(e,"url")+'must be a valid firebase URL and the path can\'t contain ".", "#", "$", "[", or "]".')};
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */sn.prototype.simpleListen=function(e,t){this.sendRequest("q",{p:e},t)},sn.prototype.echo=function(e,t){this.sendRequest("echo",{d:e},t)};Zo();class Xo{constructor(){(0,k.Z)(this,"app",void 0),(0,k.Z)(this,"realtimeDB",void 0),this.app=(0,I.Mq)(),this.realtimeDB=Qo(this.app)}getFoodShopFilterByAddress(e){return Do(zo(Mo(this.realtimeDB,"DATA"),Uo("cgg_code_nm"),Bo(e))).then((e=>e.exists()?e.val():(console.warn("No data available"),[]))).catch((e=>{console.error(`[getFoodShopFilterByAddress] error: ${e.message}`)}))}}var Jo=(0,i.aZ)({name:"AddressSelectBtn",components:{AddressModal:w},props:{address:String,color:String},data(){return{addrStr:this.address,region_2depth_name:"",dispatch:(0,m.H)()}},mounted(){this.loadLastLocation(),this.loadFilteredStoreList(this.region_2depth_name)},methods:{onArrowBtnClicked(){this.$refs.addressModalComponent.showModal()},saveLastLocation(e,t){localStorage.setItem("addressFull",e),localStorage.setItem("region_2depth_name",t)},loadLastLocation(){this.addrStr=localStorage.getItem("addressFull")||"서울 중구 태평로2가",this.region_2depth_name=localStorage.getItem("region_2depth_name")||"중구",console.log("add",this.addrStr,this.region_2depth_name)},loadFilteredStoreList(e){const t=new Xo;t.getFoodShopFilterByAddress(e).then((e=>{console.log("test",e),this.dispatch((0,g.qc)({storeListData:e}))}))},onAddressLoaded(e){console.log("addressInfo",e),this.loadFilteredStoreList(e.region_2depth_name),this.addrStr=`${e.region_1depth_name} ${e.region_2depth_name} ${e.region_3depth_name}`,this.saveLastLocation(this.addrStr,e.region_2depth_name)}}});const ea=(0,v.Z)(Jo,[["render",r],["__scopeId","data-v-f691c0ac"]]);var ta=ea}}]);
//# sourceMappingURL=887.e6ffb717.js.map